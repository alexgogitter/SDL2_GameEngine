...
fpsCounter::fpsCounter() { this->fpsFont = TTF_OpenFont(fontPath.c_str(), fontSize); }
...
void fpsCounter::update(Renderer2D *r, std::string text) { r->Renderer_ttf(text, fpsFont, src, dest, *fpsColor); }
