...
class Object
{
  ...
  public:
    ...
    ENGINE_API Object(const std::string &objectName, Resource_manager &resourceManager, Renderer2D *renderer, Renderer3D *renderer3D, ObjectId requestedId = InvalidObjectId);
    ...
    ENGINE_API Component *getComponentByTypeName(const std::string &typeName) const;
