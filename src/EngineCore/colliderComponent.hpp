...
class ColliderComponent final : public Component
{
  public:
    ...
    ColliderComponent(Object *parent, RigidbodyComponent &rigidbody, const glm::vec2 &sizePixels, float density = 1.0f, float friction = 0.6f, float restitution = 0.0f, bool isSensor = false);
