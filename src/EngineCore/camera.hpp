...
class Camera
{
  ...
  public:
    ...
    void setCullingMask(LayerMask mask) { cullingMask = mask; }

    LayerMask getCullingMask() const { return cullingMask; }
    ...
    bool rendersLayer(int layer) const { return LayerMaskContains(cullingMask, layer); }
};
