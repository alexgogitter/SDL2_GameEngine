...
public:
    ...
    void setRotation(const glm::quat& value)
    {
        ...
        rotation = quaternionLength > 0.0f
            ? glm::normalize(value)
    ...
    void setEulerRadians(const glm::vec3& value)
    {
        rotation = glm::normalize(glm::quat(value));
    }
    ...
    void rotateBy(float zRadians)
    {
        setRotation(getRotationZ() + zRadians);
    }
