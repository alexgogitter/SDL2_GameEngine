...
bool EventListener::IsKeyDown(SDL_Scancode key) const
{
    return GetKeyState(key).down;
}

bool EventListener::WasKeyPressed(SDL_Scancode key) const
{
    return GetKeyState(key).pressedThisFrame;
}

bool EventListener::WasKeyReleased(SDL_Scancode key) const
{
    return GetKeyState(key).releasedThisFrame;
}
...
bool EventListener::IsMouseButtonDown(Uint8 button) const
{
    return GetMouseButtonState(button).down;
}

bool EventListener::WasMouseButtonPressed(Uint8 button) const
{
    return GetMouseButtonState(button).pressedThisFrame;
}

bool EventListener::WasMouseButtonReleased(Uint8 button) const
{
    return GetMouseButtonState(button).releasedThisFrame;
}
...
const EventListener::MouseState& EventListener::GetMouseState() const
{
    return mouseState_;
}
...
bool EventListener::IsValidMouseButton(Uint8 button) const
{
