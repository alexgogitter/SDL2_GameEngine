...
class Rigidbody3DComponent final
    : public Component
{
public:
    ENGINE_API Rigidbody3DComponent(
        Object* parent,
...
private:
    ...
    glm::vec3 measuredAcceleration =
        {0.0f, 0.0f, 0.0f};

    glm::vec3 previousLinearVelocity =
        {0.0f, 0.0f, 0.0f};

    glm::vec3 physicsRotationDegrees =
    {0.0f, 0.0f, 0.0f};

    glm::vec3 angularVelocityDegrees =
        {0.0f, 0.0f, 0.0f};
