        ...
        switch (property.type)
        {
            ...
            case ComponentPropertyType::Enumeration:
            {
                ...
                const bool validSelection =
                    value != nullptr &&
                    property.enumerationLabels != nullptr &&
                    *value >= 0 &&
                    *value < property.enumerationCount;

                const char* preview =
                    validSelection
                        ? property.enumerationLabels[*value]
                        : "<Invalid>";
                ...
                if (ImGui::BeginCombo(label, preview))
                {
                    for (
                        int index = 0;
                        index < property.enumerationCount;
                        ++index
                    )
                    {
                        const bool selected =
                        ...
                        if (ImGui::Selectable(
                            property.enumerationLabels[index],
                            selected))
                        {
                            *value = index;
                            changed = true;
            ...
            {
                auto* value =
                    static_cast<glm::vec2*>(property.value);
            ...
            {
                auto* value =
                    static_cast<glm::vec3*>(property.value);
            ...
            {
                auto* value =
                    static_cast<glm::vec4*>(property.value);
