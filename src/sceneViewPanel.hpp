...
ENGINE_API void DrawSceneViewPanel(const RenderTarget& renderTarget, EditorCamera& editorCamera,
     Scene& scene, EditorSelection& selection, SceneViewPanelState& state);